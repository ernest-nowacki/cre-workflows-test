...
// dist/workflows/hello-world/hello-world.js
...
class Value {
  ...
  static int64(n) {
    return new Value(create(ValueSchema2, {
  ...
  static decimal(s) {
    ...
    const decimal = create(DecimalSchema, {
  ...
  static toInt64Bigint(v) {
    if (typeof v === "string") {
      const bi2 = BigInt(v);
      return Value.toInt64Bigint(bi2);
    }
    if (typeof v === "bigint") {
      if (v > Value.INT64_MAX)
        throw new Error("int64 overflow");
      else if (v < Value.INT64_MIN)
    ...
    const bi = BigInt(v);
    if (bi > Value.INT64_MAX)
      throw new Error("int64 overflow");
    else if (bi < Value.INT64_MIN)
      throw new Error("int64 underflow");
    return bi;
  }
  static toUint64Bigint(v) {
    if (typeof v === "string") {
      const bi2 = BigInt(v);
      return Value.toUint64Bigint(bi2);
    }
    if (typeof v === "bigint") {
      if (v > Value.UINT64_MAX)
...
var handleExecutionPhase = async (req, workflow, config, runtime) => {
...
var handleExecuteRequest = async (req, workflow, config, runtime) => {
  if (req.request.case === "subscribe") {
...
class DonModeError extends Error {
  ...
  method;
  mode;
  constructor(message = "cannot use DON Runtime inside Node mode", options) {
    super(message);
...
class NodeModeError extends Error {
  ...
  method;
  mode;
  constructor(message = "cannot use Node Runtime inside DON mode", options) {
    super(message);
...
var isMessageInputs = (i2) => {
  const anyI = i2;
  return anyI && typeof anyI === "object" && "observation" in anyI && anyI.observation && typeof anyI.observation === "object" && "case" in anyI.observation;
};
var isJsonInputs = (i2) => {
  const anyI = i2;
  if (!anyI || typeof anyI !== "object")
    return false;
  if (!("observation" in anyI))
    return true;
...
var toInputsJson = (input) => {
  ...
  throw new Error("runInNodeMode: invalid input shape; expected SimpleConsensusInputs message or SimpleConsensusInputsJson");
};
var runInNodeMode = async (buildConsensusInputs) => {
  const nodeRuntime2 = runtime.switchModes(2);
  let consensusInputJson;
  try {
    const consensusInput = await buildConsensusInputs(nodeRuntime2);
...
var ConfigSchema = /* @__PURE__ */ messageDesc(file_capabilities_scheduler_cron_v1_trigger, 0);
...
var consensusDescriptorMedian = create(ConsensusDescriptorSchema, {
  descriptor: {
    case: "aggregation",
    value: 1
  }
});
var consensusDescriptorIdentical = create(ConsensusDescriptorSchema, {
  descriptor: {
    case: "aggregation",
    value: 2
  }
});
var consensusDescriptorCommonPrefix = create(ConsensusDescriptorSchema, {
  descriptor: {
    case: "aggregation",
    value: 3
  }
});
var consensusDescriptorCommonSuffix = create(ConsensusDescriptorSchema, {
  descriptor: {
    case: "aggregation",
    value: 4
  }
});
var consensusAggregatorsMap = {
...
var observationValue = (value) => ({
  case: "value",
  value: value.proto
});
var getAggregatedValue = (value, consensus) => create(SimpleConsensusInputsSchema, {
...
var onCronTrigger = (_, runtime2) => {
  runtime2.logger.log("Hello, Calculator! Workflow triggered.");
