...
var fetchMathResult = async (_, config) => {
  try {
...
var onCronTrigger = async (config) => {
  const aggregatedValue = await cre.runInNodeMode(fetchMathResult, consensusMedianAggregation())(config);
